...
const UpdateCourse = () => {
    ...
    return (
        <div className="wrap">
            <h2 id="uc-heading">Update Course</h2>
            ...
            <form onSubmit={onSubmit}>
                ...
                <button className="buttons" type="submit" onClick={resetValidationErrors}>Update Course</button>
                <NavLink to={`/courses/${value.courseValues.courseId}`}><button className="buttons" onClick={resetValidationErrors}>Cancel</button></NavLink>
            </form>
        </div>
    );
}
